...
class ConvBlock(nn.Module):
    ...
    def forward(self, input: Tensor, pool_size=(2, 2), pool_type="avg"):
        x = input
...
class MobileNetV2(nn.Module):
    def __init__(
        ...
        features_lst: list[nn.Module] = [conv_bn(1, input_channel, 2)]
        ...
        features_lst.append(conv_1x1_bn(input_channel, self.last_channel))
        # make it nn.Sequential
        self.features = nn.Sequential(*features_lst)
